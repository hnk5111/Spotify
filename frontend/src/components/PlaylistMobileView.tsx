...
const PlaylistMobileView = ({ playlist, onPlaySong }: PlaylistMobileViewProps) => {
    ...
    <div className="flex flex-col h-full relative">
      ...
      <div className="sticky top-0 z-10 bg-background/95 backdrop-blur-sm border-b border-zinc-800 p-4 flex items-center justify-between">
        <Button 
          ...
          onClick={() => handlePlayPause(playlist.songs[0]?._id)}
        >
          {isPlaying ? (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className={`font-medium ${currentSongId === song._id ? 'text-green-500' : ''}`}>
                    {song.title}
                  </p>
